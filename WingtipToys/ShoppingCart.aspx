    ...
    <asp:GridView ID="CartList" runat="server" AutoGenerateColumns="False" ShowFooter="True" GridLines="Vertical" CellPadding="4"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Quantity">
                <ItemTemplate>
                    <asp:TextBox ID="PurchaseQuantity" CssClass="form-control qtdInput" Width="60" runat="server" Text="<%#: Item.Quantity %>"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Remove Item">
                <ItemTemplate>
                    <div class="form-check">
                        <asp:CheckBox CssClass="form-check-input" ID="Remove" runat="server"></asp:CheckBox>
                    </div>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
